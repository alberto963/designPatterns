...
import example.designPattern.builder.erDiagram2.ErDiagram;
import example.designPattern.builder.erDiagram2.ErDiagram.ErDiagramBuilder;

public class TestErDiagram2 {
	...
	public static void main(String[] args) throws Exception {
		...
		ErDiagram diagram = erdBuilder.addEntity("E1").addEntity("E2").addRelationship("E1", "E2", "R1")
