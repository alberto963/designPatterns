...
public class TestSchedulerR {
	public TestSchedulerR() {
		...
		System.out.println(endR1.getHours() + " " + endR1.getMinutes() + " "
				+ endR1.getSeconds());
		...
		System.out.println(endR2.getHours() + " " + endR2.getMinutes() + " "
				+ endR2.getSeconds());

		Time endR3 = SchedulerR
				.calculateEnd(timeImplementationR2, 1,
						"example.pattern.prototype.schedulerReflection.TimeImplementationR3");
		// do something with endR3
		System.out.println(endR3.getHours() + " " + endR3.getMinutes() + " "
				+ endR3.getSeconds());
	}
