...
public class Client {
	...
	/**
	 * Il metodo test crea una istanza d’ogni particolare tipo di prodotto e
	 * applica i diversi metodi forniti dalle interfacce che implementano i
	 * prodotti. Si deve notare che il cliente utilizza i prodotti, senza avere
	 * conoscenza di quali sono concretamente questi.
	 */
	...
	/**
	 * Il metodo selectTechnology riceve un oggetto corrispondente ad una
	 * famiglia particolare e lo registra dentro i propri attributi.
	 */
